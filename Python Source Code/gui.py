...
window = sg.Window('DTpyWeb GUI v0.1   06/10/2019', icon="",
...
while True:
    ...
    if event is not sg.TIMEOUT_KEY:
        ...
        # if os.path.isfile(values[3]):
        #     config.set('mainConfig', 'courseslist', str(values[3]))
        # else:
        #     sg.Popup("This file does not exist")
